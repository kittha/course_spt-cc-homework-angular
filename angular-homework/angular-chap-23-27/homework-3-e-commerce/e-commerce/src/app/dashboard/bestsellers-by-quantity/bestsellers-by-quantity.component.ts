...
@Component({
  selector: 'app-bestsellers-by-quantity',
  templateUrl: './bestsellers-by-quantity.component.html',
  styleUrls: ['./bestsellers-by-quantity.component.css']
})
export class BestsellersByQuantityComponent implements AfterViewInit {
